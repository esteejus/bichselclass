...
class Dielectric {
 ...
 public:
 Dielectric( double d_density, double d_molarmass, int zz) : density(d_density), molarmass(d_molarmass), z(zz){ atom_cm3 = (d_density/d_molarmass) *avogadro;}

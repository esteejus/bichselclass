//THIS differs from simulateDetector.cpp only in the fact the output
//is in number of electrons/cm not eV/cm
...
int main()
{
  ...
  TH1D * c_dist = new TH1D("c_dist","c_dist",400,0,400);
